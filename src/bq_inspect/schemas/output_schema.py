"""Output JSON schemas for bq-inspect commands."""
...
SCHEMA_VERSION_FIELD: dict[str, Any] = {"const": "bq-inspect.v1"}
...
JOBS_GET_OUTPUT_SCHEMA = _make_jobs_view_output_schema("full", "bq-inspect jobs get output")
JOBS_SUMMARY_OUTPUT_SCHEMA = _make_jobs_view_output_schema(
    "summary", "bq-inspect jobs summary output"
)
JOBS_QUERY_OUTPUT_SCHEMA = _make_jobs_view_output_schema("query", "bq-inspect jobs query output")
JOBS_PERFORMANCE_OUTPUT_SCHEMA = _make_jobs_view_output_schema(
    "performance", "bq-inspect jobs performance output"
)
JOBS_LINEAGE_OUTPUT_SCHEMA = _make_jobs_view_output_schema(
    "lineage", "bq-inspect jobs lineage output"
)
JOBS_IMPACT_OUTPUT_SCHEMA = _make_jobs_view_output_schema("impact", "bq-inspect jobs impact output")
