...
if TYPE_CHECKING:
    ...
    from bq_inspector.knowledge_catalog.resource_specs import KnowledgeCatalogGetDispatch
...
async def get_catalog_resource(
    ...
    *,
    ...
    return await fetch_catalog_resource(
        ...
        fetch=lambda catalog_client, request: catalog_client.get_named_resource(
            request,
            dispatch=dispatch,
        ),
    )
