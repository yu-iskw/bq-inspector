...
from bq_inspector.bigquery.adapters.google_cloud.sdk_inspection_client import SdkBigQueryClient
...
def sdk_client_fx(
    ...
    with patch(
        "bq_inspector.bigquery.adapters.google_cloud.sdk_inspection_client.bigquery.Client",
...
@pytest.mark.asyncio
async def test_get_job_maps_api_errors_to_bq_inspector_failure(
    sdk_client_fx: SdkBigQueryClient,
    bq_client_mock_fx: MagicMock,
) -> None:
    ...
    assert exc_info.value.details["code"] == "BQINSPECTOR_JOB_NOT_FOUND"
