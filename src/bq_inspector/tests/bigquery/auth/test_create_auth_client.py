...
from bq_inspector.bigquery.auth.create_auth_client import (
...
async def test_create_auth_client_without_impersonation_uses_readonly_scope() -> None:
    ...
    with patch(
        "bq_inspector.bigquery.auth.create_auth_client.auth_default",
...
async def test_create_auth_client_with_impersonation_builds_target_credentials() -> None:
    ...
    with (
        ...
        patch(
            "bq_inspector.bigquery.auth.create_auth_client.impersonated_credentials.Credentials",
